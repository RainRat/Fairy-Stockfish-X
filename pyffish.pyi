...
def from_san(variant: str, fen: str, san: str, chess960: bool = False, notation: int = NOTATION_DEFAULT) -> str: ...
...
def legal_moves(variant: str, fen: str, movelist: list[str], chess960: bool = False, notation: int = NOTATION_DEFAULT) -> list[str]: ...
...
def evaluate(variant: str, fen: str, movelist: list[str], chess960: bool = False) -> int: ...
