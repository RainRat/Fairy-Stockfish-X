...
position startpos
d")
contains "Fen: rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w - - 0 1"
...
position startpos
d")
contains "Fen: rnbqkbnr/pppppppp/8/8/8/8/8/4M3 w kq - 0 1"
out=$(run_cmds "setoption name UCI_Variant value pawnsonly
position startpos
d")
contains "Fen: 8/pppppppp/8/8/8/8/PPPPPPPP/8 w - - 0 1"
out=$(run_cmds "setoption name UCI_Variant value pawns
position startpos
d")
contains "Fen: pppppppp/8/8/8/8/8/8/PPPPPPPP w - - 0 1"
...
position startpos
d")
contains "Fen: b3b/1aaa1/5/1AAA1/B3B w - - 0 1 {0 0}"
out=$(run_cmds "setoption name UCI_Variant value ko-oshi
...
position startpos
d")
contains "Fen: c7c/2baaab2/4a4/9/9/9/4A4/2BAAAB2/C7C w - - 0 1 {0 0}"
out=$(run_cmds "setoption name UCI_Variant value oshi
...
d")
contains "Fen: 9/9/9/9/9/9/9/9/C8 b - - 0 1 {3 0}"
out=$(run_cmds "setoption name UCI_Variant value oshi
position fen 9/9/9/9/9/9/9/C8/C8 w - - 0 1 {0 0} moves a2a1
d")
contains "Fen: 9/9/9/9/9/9/9/9/C8 b - - 0 1 {0 3}"
out=$(run_cmds "setoption name UCI_Variant value oshi
...
position startpos
d")
contains "Fen: 4rrrr/4rrrr/4rrrr/4rrrr/RRRR4/RRRR4/RRRR4/RRRR4 w - - 0 1"
out=$(run_cmds "setoption name UCI_Variant value aries
position fen 8/8/8/8/8/8/7r/R7 w - - 0 1 moves a1a2 h2h1 a2a1 h1h2 a1a2 h2h1 a2a1
go depth 3")
not_contains "^bestmove h1h2$"
fi
...
d")
contains "Fen: 2h2/5/5/5/5 w - - 0 2 {0 1}"
out=$(run_cmds "setoption name UCI_Variant value ko-app-paw-na
...
go perft 1")
contains "info string variant ardri "
assert_nodes "$out" "0"
out=$(run_cmds "setoption name UCI_Variant value ardri
...
d")
contains "Fen: 4k3/8/8/4\\^3/8/8/8/8 b - - 0 1"
out=$(run_cmds "setoption name UCI_Variant value fatal-giveaway
position fen 4k3/8/8/3p4/4P3/8/8/8 w - - 0 1 moves e4d5
d")
contains "Fen: 4k3/8/8/3P4/8/8/8/8 b - - 0 1"
fi
...
position fen 4k3/8/8/3p4/4P3/8/8/8 w - - 0 1 moves e4d5
d")
contains "Fen: 4k3/8/8/8/8/8/8/8 b - - 0 1"
fi
...
d")
contains "Fen: 4k3/8/8/8/8/8/8/4K3 b - - 0 1"
...
d")
contains "Fen: r1bqkbnr/pppp1ppp/8/4K3/4P3/8/PPPP1PPP/RNBQ2NR b kq - 0 3"
fi
...
d")
contains "Fen: 4k3/8/8/4Q3/8/8/8/8 b - - 0 1"
fi
...
position startpos
d")
contains "Fen: 7k/pppppppp/8/pppppppp/PPPPPPPP/8/PPPPPPPP/K7 w - - 0 1"
out=$(run_cmds "setoption name UCI_Variant value promotion-chess
...
position startpos
d")
contains "Fen: rdcbqkbcdr/ssssssssss/10/10/10/10/SSSSSSSSSS/RDCBQKBCDR w KQkq - 0 1"
fi
...
position startpos
d")
contains "Fen: rafkanr/ppppppp/7/7/7/7/PPPPPPP/RNAFKAR w - - 0 1"
...
position startpos
d")
contains "Fen: rndwbmksbwdnr1/pppppppppppppp/14/14/14/14/14/14/14/14/14/14/PPPPPPPPPPPPPP/RNDWBSKMBWDNR1 w - - 0 1"
fi
...
position startpos
d")
contains "Fen: rnafkanr/pppppppp/8/8/8/8/PPPPPPPP/RNAFKANR w - - 0 1"
fi
...
position startpos
d")
contains "Fen: afrkbnfa/pppppppp/8/8/8/8/PPPPPPPP/AFRNBKFA w - - 0 1"
...
position startpos
d")
contains "Fen: brnfknrb/pppppppp/8/8/8/8/PPPPPPPP/BRNFKNRB w - - 0 1"
...
position startpos
d")
contains "Fen: rnefkenr/pppppppp/8/8/8/8/PPPPPPPP/RNEFKENR w - - 0 1"
out=$(run_cmds "setoption name UCI_Variant value shatranj-iraq
...
position startpos
d")
contains "Fen: rnbkqbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBKQBNR w - - 0 1"
...
position startpos
d")
contains "Fen: rnbqk1bnr/ppppppppp/9/9/9/9/9/PPPPPPPPP/RNBQK1BNR w - - 0 1"
fi
...
position startpos
d")
contains "Fen: 1m1m1m1m/m1m1m1m1/1m1m1m1m/8/8/M1M1M1M1/1M1M1M1M/M1M1M1M1 w - - 0 1"
fi
...
position startpos
d")
contains "Fen: kqbnr/ppppp/5/PPPPP/KQBNR w - - 0 1"
...
position startpos
d")
contains "Fen: nnnnnnnnn/9/9/9/9/9/9/9/NNNNNNNNN w - - 0 1"
out=$(run_cmds "setoption name UCI_Variant value jesonmor
...
d")
contains "Fen: 8/8/8/8/3R4/8/8/8 b - - 1 1"
...
d")
contains "Fen: 8/8/8/8/8/3P4/3P4/3P4 b - - 0 1"
...
d")
contains "Fen: rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 2"
...
position startpos
d")
contains "Fen: bnrqkrnb/pppppppp/8/8/8/8/PPPPPPPP/BNRQKRNB w - - 0 1"
not_contains " KQkq "
...
position startpos
d")
contains "Fen: 3prnbk/4ppqn/5ppb/P5pr/RP5p/BPP5/NQPP4/KBNRP3 w - - 0 1"
not_contains " KQkq "
out=$(run_cmds "setoption name UCI_Variant value asymmetrical
position startpos
go perft 1")
...
d")
contains "Fen: 4k3/8/8/3P4/8/8/8/4K3 b - - 0 1"
out=$(run_cmds "setoption name UCI_Variant value antimatter
...
d")
contains "Fen: 4k3/8/8/3N4/8/8/8/4K3 b - - 0 1"
...
go perft 1")
not_contains "^e1c1:"
not_contains "^j@d1,e1c1:"

out=$(run_cmds "setoption name UCI_Variant value spell-chess
position fen 6k1/8/8/8/8/8/8/Rn2K3[J] w Q - 0 1
go perft 1")
not_contains "^e1c1:"
not_contains "^j@b1,e1c1:"
